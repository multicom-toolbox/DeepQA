...
NOTE: FOR THIS SOFTWARE TO RUN, YOU NEED LINUX, PERL AND PYTHON.IT IS RECOMMENDED THAT YOU INSTALL GIT LFS AND USE THE COMMAND "git lfs pull <>" TO DOWNLOAD THE REPOSITORY.

1). Download the DeepQA tool (DeepQA.tar.gz) at http://cactus.rnet.missouri.edu/DeepQA/, or at http://sysbio.rnet.missouri.edu/bdm_download/DeepQA_cactus/DeepQA.tar.gz
	...
	--------------------------------------------
2). Unzip DeepQA.tar.gz
	$ tar -zxvf DeepQA.tar.gz

NOTE: YOU CAN ALSO DOWNLOAD THE FOLDERS FROM THE GIT REPOSITORY. YOU NEED TO INSTALL THE NECESSARY TOOLS IF YOU DO NOT HAVE "git lfs"
